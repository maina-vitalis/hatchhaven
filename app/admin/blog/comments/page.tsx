...
export default function BlogCommentsPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      setDeleting(true);
      const response = await fetch(`/api/admin/blog/comments/${selectedComment.id}`, {
        method: "DELETE",
      });
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the comment from {selectedComment?.author}. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
