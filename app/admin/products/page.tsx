...
import { Plus, LogOut, Save, X, Loader2, Package, Tag, Layers } from "lucide-react";
...
export default function ProductsPage() {
  ...
  const [breeds, setBreeds] = useState<Array<{ id: string; name: string; categoryId: string; categoryName?: string }>>([]);
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Categories group your products (e.g., Eggs, Chicken, Ducks, Turkey)
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <form onSubmit={handleCategorySubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    {categoryForm.name && (
                      <p className="text-xs text-muted-foreground">
                        Slug: <code className="px-1 py-0.5 bg-muted rounded">{generateSlug(categoryForm.name)}</code>
                      </p>
                    )}
                  </div>
                  ...
                  <div className="flex gap-3">
                    <Button type="submit" disabled={submittingCategory} className="flex-1">
                      {submittingCategory ? (
                        <>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Breeds are specific types within a category (e.g., Rhode Island Red, Cornish Cross, Brown Eggs, Chicken Breast)
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {breeds.length > 0 && (
                ...
                <form onSubmit={handleBreedSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {breedForm.name && (
                      <p className="text-xs text-muted-foreground">
                        Slug: <code className="px-1 py-0.5 bg-muted rounded">{generateSlug(breedForm.name)}</code>
                      </p>
                    )}
                  </div>
                  ...
                  <Button type="submit" disabled={submittingBreed} className="w-full md:w-auto">
                    {submittingBreed ? (
                      <>
                        <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                        Creating...
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Create products that customers can buy. Fill in the details below and click "Create Product".
                  <br />
                  <span className="text-sm mt-2 block font-medium">For Live Birds:</span>
                  <span className="text-xs">
                    Example: "Rhode Island Red - Female, Mature, $25"
                  </span>
                  <br />
                  <span className="text-sm mt-2 block font-medium">For Eggs & Meat:</span>
                  <span className="text-xs">
                    Select "N/A" for Type/Size and choose size/quantity (e.g., "Dozen", "1 lb")
                  </span>
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    {selectedBreed && (
                      <p className="text-sm text-muted-foreground">
                        Creating products for: <strong>{selectedBreed.name}</strong>
                      </p>
                    )}
                  </div>
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="N/A">N/A (For Eggs & Meat)</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="Chick">Chick (Live Birds)</SelectItem>
                            <SelectItem value="1-7 months">1-7 months (Live Birds)</SelectItem>
                            <SelectItem value="Mature">Mature (Live Birds)</SelectItem>
                            <SelectItem value="Half Dozen">Half Dozen - 6 eggs</SelectItem>
                            <SelectItem value="Dozen">Dozen - 12 eggs</SelectItem>
                            <SelectItem value="18 Pack">18 Pack eggs</SelectItem>
                            <SelectItem value="30 Pack">30 Pack eggs</SelectItem>
                            <SelectItem value="1 lb">1 lb (Meat)</SelectItem>
                            <SelectItem value="2 lbs">2 lbs (Meat)</SelectItem>
                            <SelectItem value="5 lbs">5 lbs (Meat)</SelectItem>
                            <SelectItem value="10 lbs">10 lbs (Meat)</SelectItem>
                            <SelectItem value="Whole">Whole (Meat)</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </div>
