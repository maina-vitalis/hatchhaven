...
import { BarChart3, Loader2, TrendingUp, DollarSign, ShoppingCart, Users } from "lucide-react";
...
interface AnalyticsData {
  ...
  topProducts: Array<{ name: string; category: string; quantity: number; revenue: number; orders: number }>;
  summary: {
    totalRevenue: number;
    totalOrders: number;
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Total revenue per product category</CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer
                config={{
