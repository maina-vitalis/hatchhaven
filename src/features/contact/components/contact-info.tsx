  ...
  const contactDetails: ContactDetail[] = [
    {
      icon: Phone,
      title: "Call Us",
      subtitle: "0704 938 330",
      link: "tel:+254704938330",
      ...
      <div className="container mx-auto px-4 lg:px-8 relative">
          ...
          {contactDetails.map((detail, index) => (
            ...
            >
              ...
              <CardContent className="p-8 text-center relative">
                <div
                  className={`w-16 h-16 mx-auto mb-6 rounded-2xl ${detail.color} flex items-center justify-center group-hover:scale-110 transition-transform`}
                >
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Follow us on social media for the latest updates, farm stories, and
