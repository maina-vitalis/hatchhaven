  ...
  const stages: Stage[] = [
    {
      ...
      details: [
        ...
        "Premium breeding stock selection",
      ],
    },
    {
      title: "Hatchling",
          ...
          {stages.map((stage, index) => (
            ...
            >
              <div className="relative mb-6 p-6">
                <div className="w-40 h-40 mx-auto rounded-full overflow-hidden border-4 border-primary/20 shadow-lg group-hover:border-primary transition-colors">
                  <Image
                    src={stage.image}
                    alt={stage.title}
                    width={160}
                ...
                {index < stages.length - 1 && (
                  <div className="hidden lg:block absolute top-1/2 -right-4 w-8 h-0.5 bg-primary/30 transform -translate-y-1/2 z-0">
                    <ArrowRight className="h-4 w-4 text-primary/50 absolute right-0 top-1/2 -translate-y-1/2" />
                  </div>
                )}
              </div>
