      ...
      <Dialog open={isTagDialogOpen} onOpenChange={setIsTagDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Create a new blog tag</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
      ...
      <Dialog open={isAuthorDialogOpen} onOpenChange={setIsAuthorDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Create a new blog author</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
          ...
          <DialogFooter>
            <Button
              variant="outline"
              onClick={() => setIsAuthorDialogOpen(false)}
            >
              Cancel
            </Button>
